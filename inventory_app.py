...
class Ui_MainWindow(QObject):
    ...
    def setupUi(self, MainWindow):
        ...
        self.logo_HCMUTE = QtWidgets.QLabel(parent=self.centralwidget)
        ...
        self.group_img = QtWidgets.QGroupBox(parent=self.centralwidget)
        ...
        self.result_img = QtWidgets.QLabel(parent=self.group_img)
        self.result_img.setGeometry(QtCore.QRect(110, 40, 448, 448))
        self.result_img.setObjectName("result_img")
        self.group_info = QtWidgets.QGroupBox(parent=self.centralwidget)
        ...
        self.OOS_lable = QtWidgets.QLabel(parent=self.group_info)
        ...
        self.TimeBox = QtWidgets.QGroupBox(parent=self.centralwidget)
        ...
        self.time = QtWidgets.QLabel(parent=self.TimeBox)
        self.time.setGeometry(QtCore.QRect(10, 40, 191, 71))
        font = QtGui.QFont()
        font.setFamily("Sans")
